...
class User(AbstractUser):
    ...
    region=models.IntegerField(verbose_name='région',choices=[(1,'northeast'),(2,'northwest'),(3,'southeast'),(4,'southwest')],max_length=100, default=1)
    smoker=models.CharField(choices=[("no", "Non"), ("yes", "Oui")], verbose_name='smoker', default="no", max_length=10)
